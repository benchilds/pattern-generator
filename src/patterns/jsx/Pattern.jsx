    ...
    <div className="row mb-5">
      <div className="col">
        <div className="form-group">
          ...
          <input type="number" className="form-control" id="patternCols" aria-describedby="patternColsNote" placeholder="5-20" min="5" max="20" value={props.numCols}/>
      ...
      <div className="col">
        <div className="form-group">
          ...
          <input type="number" className="form-control" id="patternRows" aria-describedby="patternRowsNote" placeholder="1-10" min="1" max="10" value={props.numRows}/>
      ...
      <div className="col">
        <div className="form-group">
          ...
          <input type="number" className="form-control" id="selectedX" aria-describedby="selectedXNote" placeholder="5-20" min="5" max="20" value={props.selX}/>
      ...
      <div className="col">
        <div className="form-group">
          ...
          <input type="number" className="form-control" id="selectedY" aria-describedby="selectedYNote" placeholder="1-10" min="1" max="10" value={props.selY}/>
